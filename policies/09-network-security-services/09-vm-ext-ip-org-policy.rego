# METADATA
# title: Guardrail 09 - GCE Public Access Prevention
# description: Check for GCE Public Access Prevention Organization Policy.
package policies.guardrail_09_vm
...
# Org Policy must be compute.vmExternalIpAccess
required_policy := "policies/compute.vmExternalIpAccess"
