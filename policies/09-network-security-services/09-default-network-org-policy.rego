# METADATA
# title: Guardrail 09 - Skip Default Network Creation
# description: Check for Skip Default Network Creation Organization Policy.
package policies.guardrail_09_default
...
# Org Policy must be skipDefaultNetworkCreation
required_policy := "policies/compute.skipDefaultNetworkCreation"
