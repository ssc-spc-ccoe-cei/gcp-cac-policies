# METADATA
# title: Guardrail 09 - Restrict Public IP Cloud SQL Org. Policy
# description: Check for Restrict Public IP access on Cloud SQL instances Organization Policy.
package policies.guardrail_09_sql
...
# Org Policy must be sql.restrictPublicIp
required_policy := "policies/sql.restrictPublicIp"
