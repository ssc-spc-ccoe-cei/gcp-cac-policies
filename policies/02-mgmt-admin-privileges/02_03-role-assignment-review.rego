...
description := {"description": "validation 03 - Role Assignment Reviews"}
...
# description: approval filename should begin with "03_APPROVAL", but can be of any suffix/file type
required_approval_filename := "03_APPROVAL"
